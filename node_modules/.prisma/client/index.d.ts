...
/**
   ...
   * `prisma.ad`: Exposes CRUD operations for the **Ad** model.
    ...
    * ```
    */
  get ad(): Prisma.AdDelegate<GlobalReject>;
}
  ...
  */
  ...
  export type GameGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'ads' ? Array < AdGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? GameCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'ads' ? Array < AdGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__GameClient<T> implements PrismaPromise<T> {
    ...
    ads<T extends AdFindManyArgs = {}>(args?: Subset<T, AdFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Ad>>, PrismaPromise<Array<AdGetPayload<T>>>>;
  ...
  export type AdAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<AdOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type AdGroupByArgs = {
    where?: AdWhereInput
    orderBy?: Enumerable<AdOrderByWithAggregationInput>
  ...
  type GetAdGroupByPayload<T extends AdGroupByArgs> = PrismaPromise<
    Array<
      PickArray<AdGroupByOutputType, T['by']> &
        {
  ...
  export type AdGetPayload<
    S extends boolean | null | undefined | AdArgs,
    U = keyof S
      > = S extends true
        ? Ad
    : S extends undefined
    ? never
    : S extends AdArgs | AdFindManyArgs
    ?'include' extends U
    ? Ad  & {
    [P in TrueKeys<S['include']>]:
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'game' ? GameGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Ad ? Ad[P] : never
  } 
    : Ad
  : Ad


  type AdCountArgs = Merge<
    Omit<AdFindManyArgs, 'select' | 'include'> & {
      select?: AdCountAggregateInputType | true
    }
  >

  export interface AdDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends AdFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, AdFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Ad'> extends True ? CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>> : CheckSelect<T, Prisma__AdClient<Ad | null >, Prisma__AdClient<AdGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends AdFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, AdFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Ad'> extends True ? CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>> : CheckSelect<T, Prisma__AdClient<Ad | null >, Prisma__AdClient<AdGetPayload<T> | null >>
    ...
    **/
    findMany<T extends AdFindManyArgs>(
      args?: SelectSubset<T, AdFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Ad>>, PrismaPromise<Array<AdGetPayload<T>>>>
    ...
    **/
    create<T extends AdCreateArgs>(
      args: SelectSubset<T, AdCreateArgs>
    ): CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>>
    ...
    **/
    delete<T extends AdDeleteArgs>(
      args: SelectSubset<T, AdDeleteArgs>
    ): CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>>
    ...
    **/
    update<T extends AdUpdateArgs>(
      args: SelectSubset<T, AdUpdateArgs>
    ): CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>>
    ...
    **/
    deleteMany<T extends AdDeleteManyArgs>(
      args?: SelectSubset<T, AdDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends AdUpdateManyArgs>(
      args: SelectSubset<T, AdUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends AdUpsertArgs>(
      args: SelectSubset<T, AdUpsertArgs>
    ): CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>>

    /**
     * Find one Ad that matches the filter or throw
     * `NotFoundError` if no matches were found.
    ...
    **/
    findUniqueOrThrow<T extends AdFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, AdFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>>
    ...
    **/
    findFirstOrThrow<T extends AdFindFirstOrThrowArgs>(
      args?: SelectSubset<T, AdFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends AdAggregateArgs>(args: Subset<T, AdAggregateArgs>): PrismaPromise<GetAdAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, AdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAdGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__AdClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * Ad base type for findUnique actions
   */
  export type AdFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Ad
     * 
    **/
    select?: AdSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: AdInclude | null
    /**
   ...
   * Ad: findUnique
   */
  export interface AdFindUniqueArgs extends AdFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * Ad base type for findFirst actions
   */
  export type AdFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Ad
     * 
    **/
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<AdScalarFieldEnum>
  }

  /**
   * Ad: findFirst
   */
  export interface AdFindFirstArgs extends AdFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type AdFindUniqueOrThrowArgs = AdFindUniqueArgsBase
      

  /**
   * Ad: findFirstOrThrow
   */
  export type AdFindFirstOrThrowArgs = AdFindFirstArgsBase
  ...
  export type AdWhereInput = {
    AND?: Enumerable<AdWhereInput>
    OR?: Enumerable<AdWhereInput>
    NOT?: Enumerable<AdWhereInput>
    id?: StringFilter | string
    name?: StringFilter | string
    yearsPlaying?: IntFilter | number
    discord?: StringFilter | string
    weekDays?: StringFilter | string
    housrStart?: IntFilter | number
    hourEnd?: IntFilter | number
    useVoiceChannel?: BoolFilter | boolean
  ...
  export type AdScalarWhereWithAggregatesInput = {
    AND?: Enumerable<AdScalarWhereWithAggregatesInput>
    OR?: Enumerable<AdScalarWhereWithAggregatesInput>
    NOT?: Enumerable<AdScalarWhereWithAggregatesInput>
    id?: StringWithAggregatesFilter | string
    name?: StringWithAggregatesFilter | string
    yearsPlaying?: IntWithAggregatesFilter | number
    discord?: StringWithAggregatesFilter | string
    weekDays?: StringWithAggregatesFilter | string
    housrStart?: IntWithAggregatesFilter | number
    hourEnd?: IntWithAggregatesFilter | number
    useVoiceChannel?: BoolWithAggregatesFilter | boolean
  ...
  export type GameCreateInput = {
    ...
    title: string
    bannerUrl: string
    ads?: AdCreateNestedManyWithoutGameInput
  }
  ...
  export type GameUncheckedCreateInput = {
    ...
    title: string
    bannerUrl: string
    ads?: AdUncheckedCreateNestedManyWithoutGameInput
  }
  ...
  export type GameUpdateInput = {
    ...
    ads?: AdUpdateManyWithoutGameNestedInput
  }
  ...
  export type GameUncheckedUpdateInput = {
    ...
    title?: StringFieldUpdateOperationsInput | string
    bannerUrl?: StringFieldUpdateOperationsInput | string
    ads?: AdUncheckedUpdateManyWithoutGameNestedInput
  }
  ...
  export type AdCreateInput = {
    ...
    game: GameCreateNestedOneWithoutAdsInput
  }
  ...
  export type AdCreateNestedManyWithoutGameInput = {
    create?: XOR<Enumerable<AdCreateWithoutGameInput>, Enumerable<AdUncheckedCreateWithoutGameInput>>
    connectOrCreate?: Enumerable<AdCreateOrConnectWithoutGameInput>
    connect?: Enumerable<AdWhereUniqueInput>
  }

  export type AdUncheckedCreateNestedManyWithoutGameInput = {
    create?: XOR<Enumerable<AdCreateWithoutGameInput>, Enumerable<AdUncheckedCreateWithoutGameInput>>
    connectOrCreate?: Enumerable<AdCreateOrConnectWithoutGameInput>
    connect?: Enumerable<AdWhereUniqueInput>
  }
  ...
  export type AdUpdateManyWithoutGameNestedInput = {
    create?: XOR<Enumerable<AdCreateWithoutGameInput>, Enumerable<AdUncheckedCreateWithoutGameInput>>
    connectOrCreate?: Enumerable<AdCreateOrConnectWithoutGameInput>
    upsert?: Enumerable<AdUpsertWithWhereUniqueWithoutGameInput>
    set?: Enumerable<AdWhereUniqueInput>
    disconnect?: Enumerable<AdWhereUniqueInput>
    delete?: Enumerable<AdWhereUniqueInput>
    connect?: Enumerable<AdWhereUniqueInput>
    update?: Enumerable<AdUpdateWithWhereUniqueWithoutGameInput>
    updateMany?: Enumerable<AdUpdateManyWithWhereWithoutGameInput>
    deleteMany?: Enumerable<AdScalarWhereInput>
  }

  export type AdUncheckedUpdateManyWithoutGameNestedInput = {
    create?: XOR<Enumerable<AdCreateWithoutGameInput>, Enumerable<AdUncheckedCreateWithoutGameInput>>
    connectOrCreate?: Enumerable<AdCreateOrConnectWithoutGameInput>
    upsert?: Enumerable<AdUpsertWithWhereUniqueWithoutGameInput>
    set?: Enumerable<AdWhereUniqueInput>
  ...
  export type GameCreateNestedOneWithoutAdsInput = {
    create?: XOR<GameCreateWithoutAdsInput, GameUncheckedCreateWithoutAdsInput>
    connectOrCreate?: GameCreateOrConnectWithoutAdsInput
  ...
  export type GameUpdateOneRequiredWithoutAdsNestedInput = {
    create?: XOR<GameCreateWithoutAdsInput, GameUncheckedCreateWithoutAdsInput>
    connectOrCreate?: GameCreateOrConnectWithoutAdsInput
    upsert?: GameUpsertWithoutAdsInput
    connect?: GameWhereUniqueInput
    update?: XOR<GameUpdateWithoutAdsInput, GameUncheckedUpdateWithoutAdsInput>
  }
  ...
  export type AdCreateOrConnectWithoutGameInput = {
    where: AdWhereUniqueInput
    create: XOR<AdCreateWithoutGameInput, AdUncheckedCreateWithoutGameInput>
  }

  export type AdUpsertWithWhereUniqueWithoutGameInput = {
    where: AdWhereUniqueInput
    update: XOR<AdUpdateWithoutGameInput, AdUncheckedUpdateWithoutGameInput>
    create: XOR<AdCreateWithoutGameInput, AdUncheckedCreateWithoutGameInput>
  }

  export type AdUpdateWithWhereUniqueWithoutGameInput = {
    where: AdWhereUniqueInput
    data: XOR<AdUpdateWithoutGameInput, AdUncheckedUpdateWithoutGameInput>
  }

  export type AdUpdateManyWithWhereWithoutGameInput = {
    where: AdScalarWhereInput
    data: XOR<AdUpdateManyMutationInput, AdUncheckedUpdateManyWithoutAdsInput>
  }

  export type AdScalarWhereInput = {
    AND?: Enumerable<AdScalarWhereInput>
    OR?: Enumerable<AdScalarWhereInput>
    NOT?: Enumerable<AdScalarWhereInput>
    id?: StringFilter | string
    name?: StringFilter | string
    yearsPlaying?: IntFilter | number
    discord?: StringFilter | string
  ...
  export type GameCreateWithoutAdsInput = {
    id?: string
    title: string
    bannerUrl: string
  }

  export type GameUncheckedCreateWithoutAdsInput = {
    id?: string
    title: string
    bannerUrl: string
  }

  export type GameCreateOrConnectWithoutAdsInput = {
    where: GameWhereUniqueInput
    create: XOR<GameCreateWithoutAdsInput, GameUncheckedCreateWithoutAdsInput>
  }

  export type GameUpsertWithoutAdsInput = {
    update: XOR<GameUpdateWithoutAdsInput, GameUncheckedUpdateWithoutAdsInput>
    create: XOR<GameCreateWithoutAdsInput, GameUncheckedCreateWithoutAdsInput>
  }

  export type GameUpdateWithoutAdsInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    bannerUrl?: StringFieldUpdateOperationsInput | string
  }

  export type GameUncheckedUpdateWithoutAdsInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    bannerUrl?: StringFieldUpdateOperationsInput | string
  }

  export type AdUpdateWithoutGameInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    yearsPlaying?: IntFieldUpdateOperationsInput | number
    discord?: StringFieldUpdateOperationsInput | string
  ...
  export type AdUncheckedUpdateWithoutGameInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    yearsPlaying?: IntFieldUpdateOperationsInput | number
    discord?: StringFieldUpdateOperationsInput | string
  ...
  export type AdUncheckedUpdateManyWithoutAdsInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    yearsPlaying?: IntFieldUpdateOperationsInput | number
    discord?: StringFieldUpdateOperationsInput | string
